  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/CrossPromo_KodanshaUSA-2.jpg" alt="Los Angeles" style="width:70%;margin : auto">
        
      </div>

      <div class="item">
        <img src="img/banner2.jpg" style="width:150%;margin:auto">
        
      </div>
    
      <div class="item">
        <img src="img/banner4.jpg" alt="New York" style="width:150%;">
